      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <ul className="my-8 space-y-1 text-sm text-gray-700">
              <li>For business calls only. No personal issues.</li>
              <li>Available on WhatsApp, SMS and for direct calls.</li>
            </ul>

            <div className="group relative w-full/3 inline-block rounded-full border border-current px-8 py-3 text-indigo-600 hover:animate-background bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]" >
              <span className="text-sm text-white font-medium transition-opacity group-hover:opacity-0">
                Follow our handles
              </span>
              <ul className="absolute inset-0 flex bg-white rounded-full overflow-hidden items-center justify-around opacity-0 transition-opacity group-hover:opacity-100">
                <li>
                  <Link
                ...
                <li>
                  <Link
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-gray-700 block rounded-full transition-opacity hover:opacity-90 focus:opacity-75 focus:outline-none"
                  >
                ...
                <li>
                  <Link
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-blue-700 block rounded-full transition-opacity hover:opacity-90 focus:opacity-75 focus:outline-none"
                  >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <p className="font-medium text-gray-900">The Band</p>
