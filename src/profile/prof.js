    ...
    <div class="bg-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
      ...
      <div class="mt-16">
        <h1 class="font-bold text-center text-3xl text-gray-900">
          {user ? user.user_metadata.fullname : "Bio Mudimba"}
        </h1>
        ...
        <div class="flex justify-between items-center my-5 px-6">
          ...
          <a href="/profile/edit" class="text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded transition duration-150 ease-in font-medium text-sm text-center w-full py-3">Edit</a>
        </div>
